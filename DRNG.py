...
class Main_Application:
    def __init__(self, root, data):
        ...
        self.gunner_icon = PhotoImage(file="./resources/icons/gunner_icon.png")
        self.scout_icon = PhotoImage(file="./resources/icons/scout_icon.png")
        self.engineer_icon = PhotoImage(file="./resources/icons/engineer_icon.png")
        self.driller_icon = PhotoImage(file="./resources/icons/driller_icon.png")
    ...
    def display_loadout(self, data, root, loadout_labels):
        ...
        self.primary_image = ImageTk.PhotoImage(Image.open(loadout.primary.image))
        ...
        self.secondary_image = ImageTk.PhotoImage(Image.open(loadout.secondary.image))
        ...
        self.first_gadget_image = ImageTk.PhotoImage(Image.open(loadout.first_gadget.image))
        ...
        self.second_gadget_image = ImageTk.PhotoImage(Image.open(loadout.second_gadget.image))
        ...
        self.grenade_image = ImageTk.PhotoImage(Image.open(loadout.grenade.image))
        ...
        self.armor_image = ImageTk.PhotoImage(Image.open(data["armor"]["image"]))
        ...
        self.pickaxe_image = ImageTk.PhotoImage(Image.open(data["pickaxe"]["image"]))
